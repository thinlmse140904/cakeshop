 ...
 * @author Admin
 */
public class ApplyChangeAndChooseImageController extends HttpServlet {
    final static Logger LOGGER = Logger.getLogger(ApplyChangeController.class);
    /**
        ...
        try {
            ...
            if(isAdmin){
                ...
                if(action.equals("Choose Image Update")){
                    url = "ChooseImageController";
                }
                else if(action.equals("Apply Change")){
                    url = "ApplyChangeController";
                }
            }else{
            ...
            LOGGER.info("ApplyChangeAndChooseImageController_NullPointerException : " + e.getMessage());
            url = "PagingController";
            request.setAttribute("COSTUMER_ERROR", "Costumer can't update product");
            request.setAttribute("IS_SHOW_COSTUMER_MSG", "block");
            LOGGER.info("AddtoCartController_Exception : Costumer can't update product");
