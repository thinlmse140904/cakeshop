...
public class DispatchFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try{
            ...
            if(!resource.equals("PagingController")){
                if(resource.endsWith("Controller")){
                    url = "PagingController";
                }
            }
            if(resource.endsWith(".png") || resource.endsWith(".jpg") ||resource.endsWith(".css") ||resource.endsWith(".img") ||resource.endsWith(".js")){
